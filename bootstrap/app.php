...
if (version_compare(PHP_VERSION, '8.0') === -1) {
    ...
    $message = 'Horizom requires at least PHP 8.0 but you are currently running PHP ' . $version[0] . '. Please update your PHP version.';
...
require_once HORIZOM_ROOT . '/vendor/autoload.php';
